    ...
    for folder in folder_list:
        ...
        for mol in mols_dfs:
            ...
            try:
                ...
                res_dict = main(molecule ,llm=llm, az_model=az_model, stability_flag="True")
                with open(f"{root_dir}/results/dfs/{folder}/run_{run_no}/{mol}_stability.json", "w") as f:
