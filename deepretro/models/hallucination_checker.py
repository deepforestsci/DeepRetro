...
class HallucinationChecker:
    ...
    def __init__(self,
        ...
        ----------
        checker_type : str
            Backend used for hallucination detection. Supported values are ``"heur"`` and ``"ml"``, default="ml"
        ...
        if self.checker_type not in ["heur", "ml"]:
            raise ValueError(f"Unknown checker_type: {self.checker_type}. Allowed: 'heur', 'ml'")
