...
def test_split_cot_json_success():
    """Tests split_cot_json function with valid response.
    split_cot_json() splits the response based on <cot>,
    <thinking> and <json> tag.
...
def test_split_json_deepseek_success():
    """Tests split_json_deepseek function with valid response.
    split_json_deepseek splits the response based on <thinking> and <jon> tag.
