...
def test_retrosynthesis_deepseek_m1p1_success():
...
def test_retrosynthesis_deepseek_m1p0_success():
    url = f"{BASE_URL}{ENDPOINTS['retrosynthesis']}"
...
def test_retrosynthesis_deepseek_m0p1_success():
    url = f"{BASE_URL}{ENDPOINTS['retrosynthesis']}"
...
def test_retrosynthesis_deepseek_m0p0_success():
    url = f"{BASE_URL}{ENDPOINTS['retrosynthesis']}"
